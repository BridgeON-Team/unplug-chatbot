...
public class ChatMessageController {
    ...
    // 메시지 전송 (인증 사용자 전용)
    @Operation(summary = "메시지 전송", description = "현재 사용자(username 기준)가 특정 스레드에 메시지를 전송합니다. GPT 응답은 자동으로 추가됩니다.")
    @PostMapping
    ...
    @Operation(summary = "스레드별 메시지 조회", description = "해당 스레드의 모든 메시지를 시간순으로 반환합니다. 자신의 스레드만 접근 가능합니다.")
    ...
    @Operation(summary = "메시지 삭제", description = "자신이 작성한 메시지만 삭제할 수 있습니다.")
